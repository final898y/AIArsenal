...
| `markdown-course-converter`| AI 課程轉 Markdown 筆記 | 內容轉化 | General / 1.5 Pro | `v1.2.3` | [`prompts/markdown-course-converter.md`](prompts/markdown-course-converter.md) | 將線上課程文字重組為高結構化、自帶 YAML Metadata 與雙向連結的 Markdown 筆記 |
